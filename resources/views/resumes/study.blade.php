<div class="form-group row">
    ...
    <div class="col-8">
        <input class="form-control" type="date" name="datebeginstudy[]" id="date-input">
    </div>
</div>
<div class="form-group row">
    <label for="date-input" class="col-4 col-form-label">End Date:</label>
    <div class="col-8">
        <input class="form-control" type="date" name="dateendstudy[]" id="date-input">
    </div>
</div>
<div class="form-group row">
    <label for="text-input" class="col-4 col-form-label">Institution Name:</label>
    <div class="col-8">
        <input class="form-control" type="text" name="studyname[]" id="text-input">
    </div>
</div>
<div class="form-group row">
    <label for="text-input" class="col-4 col-form-label">Speciality:</label>
    <div class="col-8">
        <input class="form-control" type="text" name="professionstudy[]" id="text-input">
    </div>
</div>
<div class="form-group row">
    <label for="text-input" class="col-4 col-form-label">Academic Degree:</label>
    <div class="col-8">
        <input class="form-control" type="text" name="doctor[]" id="text-input">
    </div>
</div>
<br/>